...
import com.company.ChampionStatMapper;
import com.company.ChampionStat;
...
public class 	InventoryDataStats extends Dto implements Serializable {
	...
	@ChampionStatMapper(parameter = ChampionStat.Armor)
	public double getFlatArmorMod() {
		return flatArmorMod;
	}

	@ChampionStatMapper(parameter = ChampionStat.Attack_Speed)
	...
	@ChampionStatMapper(parameter = ChampionStat.Hit_Points)
	...
	@ChampionStatMapper(parameter = ChampionStat.Ability_Power)
	public double getFlatMagicDamageMod() {
		return flatMagicDamageMod;
	}

	@ChampionStatMapper(parameter = ChampionStat.Movement_Speed)
	public double getFlatMovementSpeedMod() {
		return flatMovementSpeedMod;
	}

	@ChampionStatMapper(parameter = ChampionStat.Attack_Damage)
	public double getFlatPhysicalDamageMod() {
		return flatPhysicalDamageMod;
	}

	@ChampionStatMapper(parameter = ChampionStat.Magic_Resist)
	...
	@ChampionStatMapper(parameter = ChampionStat.Crit_Chance)
	public double getPercentCritChanceMod() {
		return percentCritChanceMod;
	}

	@ChampionStatMapper(parameter = ChampionStat.Crit_Damage)
